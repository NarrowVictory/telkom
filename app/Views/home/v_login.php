...
<head>
    ...
    <title>Login - SI Gangguan Indihome</title>
    <!-- Custom CSS -->
            ...
            <div class="auth-box bg-light">
                <div id="loginform">
                    <div class="text-center p-t-5 p-b-20">
                        <span class="db"><img height="50%" src="<?= base_url() ?>/template/assets/images/logo_ta2.png" alt="logo" /></span>
                    </div>
                    <!-- Form -->
                    <form class="form-horizontal m-t-20" id="loginform" action="<?= site_url('auth/loginProccess'); ?>" method="post">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="p-t-0">
                                        <button class="btn btn-success float-right" type="submit" style="width:100%">Login</button>
                                    </div>
                                </div>
                            </div>
                        </div>
