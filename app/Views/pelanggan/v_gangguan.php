...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <form class="form-horizontal" action="<?= site_url('pelanggan/laporgangguan') ?>" autocomplete="off" method="post">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="nomor_internet" class="form-control" value="<?= $pelanggan->nomor_internet ?>" id="nomor_internet" placeholder="Masukan Nomor Internet" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="nama_pelanggan" class="col-sm-3 text-right control-label col-form-label">Nama Pelanggan</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="nama_pelanggan" id="nama_pelanggan" value="<?= $pelanggan->nama_pelanggan ?>" placeholder="Masukan Nama Pelanggan" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="no_hp" class="col-sm-3 text-right control-label col-form-label">No. HP</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="no_hp" id="no_hp" value="<?= $pelanggan->no_hp ?>" placeholder="Masukan No. HP">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="topik_keluhan" id="topik_keluhan" placeholder="Masukan Topik Keluhan">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="detail_keluhan" class="col-sm-3 text-right control-label col-form-label">Detail Keluhan</label>
                            <div class="col-sm-6">
                                <textarea class="form-control" name="detail_keluhan" placeholder="Masukan Detail Keluhan"></textarea>
                            </div>
                        </div>
                    </div>
