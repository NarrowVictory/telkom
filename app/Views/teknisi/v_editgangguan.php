...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <form class="form-horizontal" action="<?= site_url('teknisi/gangguan/edit/' . $gangguan->id_tickets) ?>" autocomplete="off" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" style="border: none; outline: none; background:transparent" readonly value="<?= date("d-M-Y H:i:s", strtotime($gangguan->tgl_keluhan)); ?>" class="form-control" name="tgl_keluhan" id="tgl_keluhan" placeholder="Password Here">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="tgl_proses" class="col-sm-3 text-right control-label col-form-label">Tanggal Proses</label>
                            <div class="col-sm-6">
                                <input type="text" style="border: none; outline: none; background:transparent" readonly value="<?php if (isset($gangguan->tgl_proses)) {
                                                                                                                                    echo date("d-M-Y H:i:s", strtotime($gangguan->tgl_proses));
                                                                                                                                } else {
                                                                                                                                    echo "Laporan Belum Diproses";
                                                                                                                                } ?>" class="form-control" name="tgl_proses" id="tgl_proses" placeholder="Password Here">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="tgl_selesai" class="col-sm-3 text-right control-label col-form-label">Tanggal Selesai</label>
                            <div class="col-sm-6">
                                <input type="text" style="border: none; outline: none; background:transparent" readonly value="<?php if (isset($gangguan->tgl_selesai)) {
                                                                                                                                    echo date("d-M-Y H:i:s", strtotime($gangguan->tgl_selesai));
                                                                                                                                } else {
                                                                                                                                    echo "Laporan Belum Diselesaikan";
                                                                                                                                } ?>" class="form-control" name="tgl_selesai" id="tgl_selesai" placeholder="Password Here">
                            </div>
                        </div>
                    </div>
